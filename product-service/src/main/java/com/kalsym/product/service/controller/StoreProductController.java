...
import com.kalsym.product.service.request.ProductRequest;
...
//            @PathVariable String storeId, @Valid 
//            @RequestBody ProductRequest bodyProductRequest) 
//    {
//        Product newProduct = bodyProductRequest.getProduct();
//        ProductReview newProductReview = bodyProductRequest.getProductReview();
//        ProductVariant newProductVariant = bodyProductRequest.getProductVariant();
//        ProductVariantAvailable newProductVariantAvailable = bodyProductRequest.getProductVariantAvailable();
//        
//        HttpResponse response = new HttpResponse(request.getRequestURI());
//        
////        Optional<Store> optStore = storeRepository.findById(storeId);
...
////        
////        for (Product existingProduct : products) {
////            if (existingProduct.getName().equals(newProduct.getName()) && !"DELETED".equalsIgnoreCase(existingProduct.getStatus())) {
////                response.setStatus(HttpStatus.CONFLICT);
////                response.setData("Product name already exists");
////                return ResponseEntity.status(response.getStatus()).body(response);
////            }
////
////        }
//        
//        newProductReview.setProductId(newProduct.getId());
//        newProductVariant.setProduct(newProduct);
//        newProductVariantAvailable.setProductId(newProduct.getId());
//        newProductVariantAvailable.setProductVariantId(newProductVariant.getId());
//        response.setStatus(HttpStatus.CREATED);
//        productRepository.save(newProduct); 
//        productReviewRepository.save(newProductReview); 
//        productVariantRepository.save(newProductVariant);
//        productVariantAvailableRepository.save(newProductVariantAvailable);
